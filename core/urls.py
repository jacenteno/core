...
# Importa tu vista personalizada de cierre de sesión
from lottoluck.views import custom_logout


urlpatterns = [
    path('login/', LoginView.as_view(), name='login'),
    # path('', lambda request: redirect('/lottoluck/contadores/')),  # Redirección de la página de inicio a la nueva ruta
    # Redirección permanente a la nueva ruta
    path('', lambda request: redirect('/lottoluck/index/', permanent=True)),
